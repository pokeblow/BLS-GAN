...
class Data_Loader(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if overlap_size < 20:
            range_size = 8
            image, upper_mask, lower_mask, image_upper, image_lower = self.create_overlap(image, upper_mask, lower_mask, image_upper, image_lower, background)
            fake_flag = 1
        else:
            range_size = 0
...
if __name__ == "__main__":
    data_path = ROOT_PATH + '/Data/LS_K1_all_train'
